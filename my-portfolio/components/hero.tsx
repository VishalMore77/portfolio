    ...
    <section className="relative flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center overflow-hidden py-10 md:py-20">
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="flex flex-col items-center lg:items-start gap-6 text-center lg:text-left order-2 lg:order-1 lg:pl-20">
            <motion.div
          ...
          >
             <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-[400px] lg:h-[400px]">
               <Image
                 ...
                 alt="Vishal More"
                 fill
                 className="object-cover object-top rounded-full border-4 border-background shadow-2xl"
                 priority
               />
             </div>
          </motion.div>
